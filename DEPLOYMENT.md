...
- `npx vitest run` → semua test lolos (saat ini **632/632** — 61 file)
...
- [x] Validasi otomatis: tsc 0 error, **632/632 test** (61 file), build produksi sukses (diverifikasi v4.8.1)
